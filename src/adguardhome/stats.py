...
class AdGuardHomeStats:
    ...
    async def dns_queries(self) -> int:
        ...
        """
        response = await self._adguard.request("stats")
    ...
    async def period(self) -> int:
        ...
        """
        response = await self._adguard.request("stats_info")
    ...
    async def reset(self) -> None:
        ...
        """
        try:
            await self._adguard.request("stats_reset", method="POST")
